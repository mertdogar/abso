...
var lunary__default = /*#__PURE__*/_interopDefault(lunary);
  ...
  "src/callbacks/lunary.ts"() {
    ...
    _LunaryCallback = class _LunaryCallback {
      ...
      onChatStart(id, request) {
        ...
        lunary__default.default.trackEvent("llm", "start", {
          runId: id,
          model: request.model,
      ...
      onChatEnd(id, result) {
        lunary__default.default.trackEvent("llm", "end", {
          runId: id,
          model: result.model,
      ...
      onChatError(id, error) {
        lunary__default.default.trackEvent("llm", "error", {
          runId: id,
          error: {
